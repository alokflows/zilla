...
**Current phase:** Phase 0 ✅ done → Phase 1 in progress (turn pipeline + scheduler runtime extracted to `zilla/core.py`; bridge/health seams + live Telegram round-trip remain)
**Working branch:** `claude/zilla-harness-review-0v96bs`
**Last session:** 2026-07-16 night (MacBook) — scheduler runtime **PART A**
...
schema) is NOT in the tree** — the executor reverted it mid-commit-split when
