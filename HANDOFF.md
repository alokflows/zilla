...
session log below.
**NEXT UNIT OF WORK: K4 (graph views, `/graph` HTML), THEN K5 (team relay,
...
step — the gate is now 18 files: test_fixes/test_interactive/test_core/
...
test_service/test_zilla_home/test_memory_k1/test_memory_k2/test_memory_k3,
plus `import bot; import zilla.core; import zilla.cli; import zilla.tui.app;
import schedule_query; import zilla.graph; import memgraph`. **K3 session
...
**Tests (fresh per-file recount, 2026-07-19 K3 session):** 291 fixes +
...
28 memory_k2 + 27 memory_k3 = **1105 green** —
...
test_zilla_home.py / test_memory_k1.py / test_memory_k2.py / test_memory_k3.py`
