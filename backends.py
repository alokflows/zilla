...
def _ensure_mcp_configs() -> None:
    ...
    from config import (MCP_CONFIG_DIR, MCP_BROWSER_CONFIG, MCP_NONE_CONFIG,
...
def run_claude(
    ...
    from harness import wrap_prompt
    ...
    from config import MCP_BROWSER_CONFIG, MCP_NONE_CONFIG, MCP_STARTUP_TIMEOUT_MS
    _ensure_mcp_configs()
